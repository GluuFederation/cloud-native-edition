...
def determine_ip_nodes():
    ...
    try:
        ...
        for node in node_list:
            ...
            if gluu_settings.db.get("global.storageClass.provisioner") in ("microk8s.io/hostpath", "k8s.io/minikube-hostpath"):
        ...
        if gluu_settings.db.get("installer-settings.volumeProvisionStrategy") in ("eks", "gke", "do", "local", "aks"):
