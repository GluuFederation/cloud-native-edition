...
def determine_ip_nodes():
    ...
    try:
        ...
        for node in node_list:
            ...
            if gluu_settings.db.get("CN_DEPLOYMENT_ARCH") in ("microk8s", "minikube"):
                ...
                if gluu_settings.db.get("CN_DEPLOYMENT_ARCH") not in ("do", "local"):
        ...
        if gluu_settings.db.get("CN_DEPLOYMENT_ARCH") in ("eks", "gke", "do", "local", "aks"):
