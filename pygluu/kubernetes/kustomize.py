...
class Kustomize(object):
    ...
    def parse_configmap(self, app_file):
        ...
        if self.settings.get("ENABLE_CLIENT_API") == "Y":
            ...
            configmap_parser["data"]["CN_CLIENT_API_ADMIN_CERT_CN"] = self.settings.get("CLIENT_API_ADMIN_KEYSTORE_CN")
        # casa
        configmap_parser["data"]["CN_CLIENT_API_SERVER_URL"] = self.settings.get("CLIENT_API_APPLICATION_KEYSTORE_CN") + ":8443"
