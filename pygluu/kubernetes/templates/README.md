...
=== "Helm"
    ...
    === "oxtrust"
        ...
        | `oxtrust.image.tag`                                | oxTrust image tag repository                                                                                                     | `5.0.0_dev`                          |
...
| ----------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `ACCEPT_CN_LICENSE`                           | Accept the [License](https://www.gluu.org/license/cloud-native-edition/)         | `"Y"` or `"N"`                                                                              |
...
| `IS_CN_FQDN_REGISTERED`                       | Is Gluu FQDN globally resolvable                                                 | `"Y"` or `"N"`                                                                              |
