...
![Version: 1.8.2](https://img.shields.io/badge/Version-1.8.2-informational?style=flat-square) ![AppVersion: 4.5.0](https://img.shields.io/badge/AppVersion-4.5.0-informational?style=flat-square)
...
|  | cr-rotate | 1.8.2 |
|  | fido2 | 1.8.2 |
|  | gluu-alb-ingress | 1.8.2 |
|  | gluu-istio-ingress | 1.8.2 |
|  | jackrabbit | 1.8.2 |
|  | nginx-ingress | 1.8.2 |
|  | opendj | 1.8.2 |
|  | oxauth | 1.8.2 |
|  | oxauth-key-rotation | 1.8.2 |
|  | oxd-server | 1.8.2 |
|  | oxpassport | 1.8.2 |
|  | oxshibboleth | 1.8.2 |
|  | oxtrust | 1.8.2 |
...
| casa.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| cr-rotate | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/cr-rotate","tag":"4.5.0-3"},"resources":{"limits":{"cpu":"200m","memory":"200Mi"},"requests":{"cpu":"200m","memory":"200Mi"}},"service":{"crRotateServiceName":"cr-rotate","name":"http-cr-rotate","port":8084},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | CacheRefreshRotation is a special container to monitor cache refresh on oxTrust containers. This may be depreciated. |
...
| cr-rotate.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| global.upgrade.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| jackrabbit.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| opendj.image.tag | string | `"4.5.0-5"` | Image  tag to use for deploying. |
...
| oxauth-key-rotation.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| oxauth.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| oxd-server.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| oxpassport.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| oxshibboleth.image.tag | string | `"4.5.0-4"` | Image  tag to use for deploying. |
...
| oxtrust.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/persistence","tag":"4.5.0-3"},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"4.5.0-3"` | Image  tag to use for deploying. |
