...
![Version: 1.8.34](https://img.shields.io/badge/Version-1.8.34-informational?style=flat-square) ![AppVersion: 4.5.4](https://img.shields.io/badge/AppVersion-4.5.4-informational?style=flat-square)
...
|  | cr-rotate | 1.8.34 |
|  | fido2 | 1.8.34 |
|  | gluu-alb-ingress | 1.8.34 |
|  | gluu-istio-ingress | 1.8.34 |
|  | jackrabbit | 1.8.34 |
|  | nginx-ingress | 1.8.34 |
|  | opendj | 1.8.34 |
|  | oxauth | 1.8.34 |
|  | oxauth-key-rotation | 1.8.34 |
|  | oxd-server | 1.8.34 |
|  | oxpassport | 1.8.34 |
|  | oxshibboleth | 1.8.34 |
|  | oxtrust | 1.8.34 |
...
| oxd-server.livenessProbe | object | `{"exec":{"command":["curl","-k","http://localhost:8080/health-check"]},"initialDelaySeconds":30,"periodSeconds":30,"timeoutSeconds":5}` | Configure the liveness healthcheck for the auth server if needed. |
| oxd-server.livenessProbe.exec | object | `{"command":["curl","-k","http://localhost:8080/health-check"]}` | Executes the python3 healthcheck. |
| oxd-server.pdb | object | `{"enabled":true,"maxUnavailable":"90%"}` | Configure the PodDisruptionBudget |
| oxd-server.readinessProbe | object | `{"exec":{"command":["curl","-k","http://localhost:8080/health-check"]},"initialDelaySeconds":25,"periodSeconds":25,"timeoutSeconds":5}` | Configure the readiness healthcheck for the auth server if needed. |
