...
![Version: 1.8.10](https://img.shields.io/badge/Version-1.8.10-informational?style=flat-square) ![AppVersion: 4.5.0](https://img.shields.io/badge/AppVersion-4.5.0-informational?style=flat-square)
...
|  | cr-rotate | 1.8.10 |
|  | fido2 | 1.8.10 |
|  | gluu-alb-ingress | 1.8.10 |
|  | gluu-istio-ingress | 1.8.10 |
|  | jackrabbit | 1.8.10 |
|  | nginx-ingress | 1.8.10 |
|  | opendj | 1.8.10 |
|  | oxauth | 1.8.10 |
|  | oxauth-key-rotation | 1.8.10 |
|  | oxd-server | 1.8.10 |
|  | oxpassport | 1.8.10 |
|  | oxshibboleth | 1.8.10 |
|  | oxtrust | 1.8.10 |
...
| casa.image.tag | string | `"4.5.0-6"` | Image  tag to use for deploying. |
...
| casa.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| config.image.tag | string | `"4.5.0-5"` | Image  tag to use for deploying. |
...
| config.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| cr-rotate | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/cr-rotate","tag":"4.5.0-5"},"preStop":{},"resources":{"limits":{"cpu":"200m","memory":"200Mi"},"requests":{"cpu":"200m","memory":"200Mi"}},"service":{"crRotateServiceName":"cr-rotate","name":"http-cr-rotate","port":8084},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | CacheRefreshRotation is a special container to monitor cache refresh on oxTrust containers. This may be depreciated. |
...
| cr-rotate.image.tag | string | `"4.5.0-5"` | Image  tag to use for deploying. |
| cr-rotate.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| fido2.image.tag | string | `"4.5.0-6"` | Image  tag to use for deploying. |
...
| fido2.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| global.upgrade.image.tag | string | `"4.5.0-6"` | Image  tag to use for deploying. |
...
| jackrabbit.image.tag | string | `"4.5.0-6"` | Image  tag to use for deploying. |
...
| jackrabbit.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| opendj.image.tag | string | `"4.5.0-8"` | Image  tag to use for deploying. |
...
| opendj.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| oxauth-key-rotation.image.tag | string | `"4.5.0-5"` | Image  tag to use for deploying. |
| oxauth-key-rotation.keysLife | int | `48` | Auth server key rotation keys life in hours |
| oxauth-key-rotation.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| oxauth.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| oxd-server.image.tag | string | `"4.5.0-6"` | Image  tag to use for deploying. |
...
| oxd-server.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| oxpassport.image.tag | string | `"4.5.0-5"` | Image  tag to use for deploying. |
...
| oxpassport.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| oxshibboleth.image.tag | string | `"4.5.0-9"` | Image  tag to use for deploying. |
...
| oxshibboleth.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| oxtrust.image.tag | string | `"4.5.0-6"` | Image  tag to use for deploying. |
...
| oxtrust.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/persistence","tag":"4.5.0-5"},"preStop":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"4.5.0-5"` | Image  tag to use for deploying. |
| persistence.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
...
| scim.image.tag | string | `"4.5.0-6"` | Image  tag to use for deploying. |
...
| scim.preStop | object | `{}` | Add custom preStop https://github.com/GluuFederation/cloud-native-edition/discussions/516 |
