...
![Version: 1.6.15](https://img.shields.io/badge/Version-1.6.15-informational?style=flat-square) ![AppVersion: 4.3.1](https://img.shields.io/badge/AppVersion-4.3.1-informational?style=flat-square)
...
|  | cr-rotate | 1.6.15 |
|  | fido2 | 1.6.15 |
|  | gluu-alb-ingress | 1.6.15 |
|  | gluu-istio-ingress | 1.6.15 |
|  | jackrabbit | 1.6.15 |
|  | nginx-ingress | 1.6.15 |
|  | opendj | 1.6.15 |
|  | oxauth | 1.6.15 |
|  | oxauth-key-rotation | 1.6.15 |
|  | oxd-server | 1.6.15 |
|  | oxpassport | 1.6.15 |
|  | oxshibboleth | 1.6.15 |
|  | oxtrust | 1.6.15 |
...
| casa.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| cr-rotate | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/cr-rotate","tag":"4.3.1_01"},"resources":{"limits":{"cpu":"200m","memory":"200Mi"},"requests":{"cpu":"200m","memory":"200Mi"}},"service":{"crRotateServiceName":"cr-rotate","name":"http-cr-rotate","port":8084},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | CacheRefreshRotation is a special container to monitor cache refresh on oxTrust containers. This may be depreciated. |
...
| cr-rotate.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| global.upgrade.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| jackrabbit.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| opendj.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| oxauth-key-rotation.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| oxauth.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| oxd-server.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| oxpassport.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| oxshibboleth.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| oxtrust.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/persistence","tag":"4.3.1_01"},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"4.3.1_01"` | Image  tag to use for deploying. |
