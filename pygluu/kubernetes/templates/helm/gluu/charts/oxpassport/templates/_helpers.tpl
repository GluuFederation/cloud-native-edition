...
{{/*
     Common labels
*/}}
{{- define "oxpassport.labels" -}}
app: {{ include "oxpassport.name" . }}
helm.sh/chart: {{ include "oxpassport.chart" . }}
...
*/}}
{{- define "oxpassport.usr-secret-envs"}}
...
*/}}
{{- define "oxpassport.topology-spread-constraints"}}
